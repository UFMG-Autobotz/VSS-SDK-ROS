...
// optional string name = 5;
inline bool Global_Commands::has_name() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void Global_Commands::set_has_name() {
  _has_bits_[0] |= 0x00000010u;
}
inline void Global_Commands::clear_has_name() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void Global_Commands::clear_name() {
  if (name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    name_->clear();
  }
  clear_has_name();
}
inline const ::std::string& Global_Commands::name() const {
  // @@protoc_insertion_point(field_get:vss_command.Global_Commands.name)
  return *name_;
}
inline void Global_Commands::set_name(const ::std::string& value) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    name_ = new ::std::string;
  }
  name_->assign(value);
  // @@protoc_insertion_point(field_set:vss_command.Global_Commands.name)
}
inline void Global_Commands::set_name(const char* value) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    name_ = new ::std::string;
  }
  name_->assign(value);
  // @@protoc_insertion_point(field_set_char:vss_command.Global_Commands.name)
}
inline void Global_Commands::set_name(const char* value, size_t size) {
  set_has_name();
  if (name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    name_ = new ::std::string;
  }
  name_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:vss_command.Global_Commands.name)
}
inline ::std::string* Global_Commands::mutable_name() {
  set_has_name();
  if (name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    name_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:vss_command.Global_Commands.name)
  return name_;
}
inline ::std::string* Global_Commands::release_name() {
  clear_has_name();
  if (name_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
...
inline void Global_Commands::set_allocated_name(::std::string* name) {
  if (name_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete name_;
  }
  if (name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:vss_command.Global_Commands.name)
}
